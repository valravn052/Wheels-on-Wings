            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="bikes.php?action=add&id=<?php echo $row["bike_id"]; ?>">

                            <div class="cart">
                                <!--img src="<?php //echo $row["image"]; ?>" class="img-responsive"-->
                                <h2 class="text-info"><?php echo $row["bike_brand"]; ?></h2>
                                <h3 class="text-info"><?php echo $row["bike_name"]; ?></h3>
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="bikes.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
