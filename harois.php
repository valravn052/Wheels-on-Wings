    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="harois.php"</script>';
            }else{
                echo '<script>alert("Product is already Added to Cart")</script>';
                echo '<script>window.location="dbpeak.php"</script>';
            }
        }else{
            $item_array = array(
                'product_id' => $_GET["id"],
...
<body>
    ...
    <div class="container" style="width: 65%">
        <h2>Haro Interstate</h2>

        <div align="center">
    <form action="harois.php">
        <table border="1" style="width = 50%">
            <tr>
                <img src="images/interstate.jpg">
            </tr>
            ...
            <tr>
              <td><label>Gears</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT gears FROM bikes WHERE bike_name = 'Interstate'");
                    ?>
            ...
            <tr>
              <td><label>Frames</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT frames FROM bikes WHERE bike_name = 'Interstate'");
                    ?>
            ...
            <tr>
              <td><label>Wheels</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT wheels FROM bikes WHERE bike_name = 'Interstate'");
                    ?>
            ...
            <tr>
              <td><label>Brakes</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT brakes FROM bikes WHERE bike_name = 'Interstate'");
                    ?>
        ...
        <?php
            $query = "SELECT * FROM bikes WHERE bike_name = 'Interstate'";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="dbpeak.php?action=add&id=<?php echo $row["bike_id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="harois.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
