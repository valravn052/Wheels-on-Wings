    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="dbhook.php"</script>';
            }else{
...
<body>
    ...
    <div class="menu">
        <ul>
            ...
            <li><a href="bikes.php">Bikes</a></li>s
    ...
    <div class="container" style="width: 65%">
        <h2>Diamond Back Hook</h2>

        <div align="center">
    <form action="dbhook.php">
        <table border="1" style="width = 50%">
            <tr>
                <img src="images/dbhook.png" width="75%">
            </tr>
            ...
            <tr>
              <td><label>Gears</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT gears FROM bikes WHERE bike_name = 'hook'");
                    ?>
            ...
            <tr>
              <td><label>Frames</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT frames FROM bikes WHERE bike_name = 'hook'");
                    ?>
            ...
            <tr>
              <td><label>Wheels</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT wheels FROM bikes WHERE bike_name = 'hook'");
                    ?>
            ...
            <tr>
              <td><label>Brakes</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT brakes FROM bikes WHERE bike_name = 'hook'");
                    ?>
        ...
        <?php
            $query = "SELECT * FROM bikes WHERE bike_name = 'hook'";
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="dbhook.php?action=add&id=<?php echo $row["bike_id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="dbhook.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
