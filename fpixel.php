            ...
            <tr>
              <td><label>Gears</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT gears FROM bikes WHERE bike_name = 'Pixel'");
                    ?>
            ...
            <tr>
              <td><label>Frames</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT frames FROM bikes WHERE bike_name = 'Pixel'");
                    ?>
            ...
            <tr>
              <td><label>Wheels</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT wheels FROM bikes WHERE bike_name = 'Pixel'");
                    ?>
            ...
            <tr>
              <td><label>Brakes</label></td>
                <td>
                    ...
                    $resultSet = $mysqli->query("SELECT DISTINCT brakes FROM bikes WHERE bike_name = 'Pixel'");
                    ?>
